...
public class EditTemplate extends Activity {
        ...
        buttonSave.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (validateData()) {
                    retrieveContactInfo();
                    saveContact();
                    Toast.makeText(EditTemplate.this, "Contact Saved!", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        });
    ...
    private boolean validateData() {
        if (textName.getText().toString().equals("")) {
            Toast.makeText(EditTemplate.this, "Please enter a Contact Name.", Toast.LENGTH_SHORT).show();
            return false;
        }
